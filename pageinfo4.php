...
<link href="pageinfo4.css" rel="stylesheet">
...
<body onload="window.open('page4','InlineFrameScreen');return false;">


<div id="space"><br></div>
<div id="container">
<div id="wb_EmbeddedPageCNNESPA" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:14;">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:0px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<!-- cajon -->
<div id="Html2" style="position:absolute;left:0px;top:0px;width:35px;height:16px;z-index:16">
<img class="logochannel" src="https://yt3.ggpht.com/ytc/AKedOLTGHD-PWbvptwcHMXbABqSwiD6s3Ktc70LgD2KTodo=s48-c-k-c0x00ffffff-no-rj">
...
<h5><p>CNN NOTICIAS<br>canal de Noticias<br>EEUU</p></h5>
<h5><p2>CNN EN ESPAÑOL</p2></h5></div>
</div>
</body>
</html>