...
<body onload="**//window.open('menu_pel','InlineFrameSidebar2');return false;">
<div id="space"><br></div>
<div id="container">
...
<li class="active" aria-current="page">PELICULAS</li>
</ul>
</div>
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:0px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<iframe name="InlineFrameSidebar2" id="InlineFrameSidebar2" class="h6" style="position:absolute;left:631px;top:183px;width:238px;height:389px;z-index:12;" src="./menu_pel.php" scrolling="no"></iframe>
