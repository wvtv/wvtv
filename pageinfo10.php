...
<body onload="window.open('page10','InlineFrameScreen');return false;">
<div id="space"><br></div>
<div id="container">
<div id="wb_EmbeddedPagertnoticias" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:14;">
...
<iframe name="InlineFrameCon" id="InlineFrameCon" src="./mathematics.php" scrolling="no"></iframe>
</div>
<div class="section4">
</div>
<div class="banerads">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:0px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<!-- INFOCHANNEL -->
<div id="Html1" style="position:absolute;left:0px;top:0px;width:31px;height:32px;z-index:16">
<img src="https://yt3.ggpht.com/ytc/AKedOLQ4k1VyVdHKJtQimblaWo_0ihEr6eokCYggeRUIxUE=s88-c-k-c0x00ffffff-no-rj" class="logochannel" >
<img src="https://images.emojiterra.com/twitter/v13.1/512px/1f1f7-1f1fa.png" class="flagcountry" >
<h5><p>RUSSIAN TODAY<br>Canal de Noticias<br>RUSIA</p></h5>
<h5 class="status_live">LIVE</h5>
<h5><p2>RT NOTICIAS EN ESPAÑOL</p2></h5></div>
</div>
</body>
</html>