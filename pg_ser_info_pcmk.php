...
<body onload="window.open('pg_ser_intro_pcmkr','InlineFrameScreen');return false;">
<div id="space"><br></div>
<div id="container">
<div id="wb_EmbeddedPageSeries_peacemaker" style="position:absolute;left:0px;top:0px;width:872px;height:606px;z-index:14;">
...
<a href="https://www.wysiwygwebbuilder.com" target="_blank"><img src="images/builtwithwwb17.png" alt="WYSIWYG Web Builder" style="position:absolute;left:0px;top:0px;margin: 0;border-width:0;z-index:250" width="16" height="16"></a>
<!-- cortesiax -->
<div id="Html3" style="position:absolute;left:0px;top:0px;width:16px;height:46px;z-index:16">
<img class="logochannel" src=""  >
<img class="flagcountry" src=""  >
<h5 class="status_vod">VOD</h5>
<h5><p>PEACEMAKER<br>Acción, Drama, Ficción,<br>2022</p></h5>
<h5><p2>La Carátula</p2></h5></div>
</div>
</body>
</html>